...
home_stats as (
	select
		...
		string_to_array(pms.position, ',') as home_position,
		array[]:varchar[] as away_position,
...
away_stats as (
	select
		...
		array[]:varchar[] as home_position,
		string_to_array(pms.position, ',') as away_position,
