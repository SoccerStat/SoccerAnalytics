...
joined as (
    ...
    group by h.id_comp, h.competition, h.id_match, h.id_player, h.id_team, s.player_out
)
...
joined as (
    ...
    group by a.id_comp, a.competition, a.id_match, a.id_player, a.id_team, s.player_out
)
insert into analytics.staging_players_performance
select *
from joined;