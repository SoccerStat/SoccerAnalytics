drop function if exists analytics.all_players_rankings;

create function analytics.all_players_rankings(in_comps character varying[], in_seasons character varying[], group_by_club boolean DEFAULT true, group_by_competition boolean DEFAULT true, group_by_season boolean DEFAULT true, first_week integer DEFAULT 0, last_week integer DEFAULT 100, first_date character varying DEFAULT '1970-01-01'::character varying, last_date character varying DEFAULT '2099-12-31'::character varying, day_slots character varying[] DEFAULT '{}'::character varying[], time_slots character varying[] DEFAULT '{}'::character varying[], side analytics.side DEFAULT 'both'::analytics.side, r integer DEFAULT 2)
    returns TABLE("Player" character varying, "Club" character varying[], "Competition" character varying[], "Season" character varying[], "Matches" bigint, "Minutes" bigint, "Minutes/Match" numeric, "Captain" bigint, "Started" bigint, "Sub In" bigint, "Sub Out" bigint, "Wins" bigint, "Draws" bigint, "Loses" bigint, "Goals" bigint, "Assists" bigint, "Succ Penalties" bigint, "Att Penalties" bigint, "Rate Penalties" numeric, "xG (fbref)" numeric, "xG (fbref)/90" numeric, "Clean Sheets" bigint, "Yellow Cards" bigint, "Red Cards" bigint, "Incl. 2nd Yellow Cards" bigint)
    language plpgsql
as
$$
DECLARE
